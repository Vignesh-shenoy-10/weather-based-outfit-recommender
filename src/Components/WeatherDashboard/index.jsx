...
function getWeatherIcon(main) {
  if (!main) return <CloudRoundedIcon sx={{ fontSize: 58, color: "#fff" }} />;
  if (
    main.toLowerCase().includes("sun") ||
    main.toLowerCase().includes("clear")
  )
    return <WbSunnyRoundedIcon sx={{ fontSize: 58, color: "#ffd600" }} />;
  if (
    main.toLowerCase().includes("storm") ||
    main.toLowerCase().includes("thunder")
  )
    return <ThunderstormRoundedIcon sx={{ fontSize: 58, color: "#fbc02d" }} />;
  return <CloudRoundedIcon sx={{ fontSize: 58, color: "#fff" }} />;
}
